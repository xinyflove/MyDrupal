...
<div class="headerwrap" data-options="region:'north',border:false">
    <div class="header">
        <h1 class="logo"><a href="<?php print url('homepage'); ?>"><img src="/<?php print path_to_theme();?>/images/logo.png" width="147" height="35" alt="阿尔普尔" /></a></h1>
        <div id="Nav">
            <ul>
                 <li><a href="<?php print url('realdata'); ?>"><span class="bg01">实时状态</span></a></li>
                <li><a class="active" href="<?php print url('dataanalyse/realtime'); ?>"><span class="bg02">数据分析</span></a></li>
                <li><a href="<?php print url('itsm'); ?>"><span class="bg03">运维管理</span></a></li>
                <li><a href="<?php print url('gis'); ?>"><span class="bg04">GIS地图</span></a></li>
                <li><a href="<?php print url('syssetting'); ?>"><span class="bg08">系统配置</span></a></li>
            </ul>
        </div>
        <div class="userInfo">
            <div class="info"><a class="infolink" href="javascript:void(0);"><img src="/<?php print path_to_theme();?>/images/com_ico001.png" width="14" height="14" alt="信息" />00</a></div>
...
<div class="main" data-options="region:'center'" style="background-color:#f4f4f4;">
