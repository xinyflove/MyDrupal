...
<div class="headerwrap" data-options="region:'north',border:false">
    <div class="header">
        <h1 class="logo"><a href="<?php print url('homepage'); ?>"><img src="<?php print $logo; ?>" width="270" height="39" alt="消防云" /></a></h1>
        <div id="Nav">
            <ul>
                <li><a href="<?php print url('kpi/data'); ?>" class="active">数据分析</a></li>
                <li><a href="<?php print url('kpi/compare'); ?>" >数据对比</a></li>
            </ul>
        </div>
        <div class="userInfo">
...
<!--headerwrap end-->
 <div class="main-wraper" data-options="region:'center'" style="padding-bottom:5px;">

<div class="easyui-layout" data-options="fit:true">
   <?php if ($page['sidebar_first']): ?>
        <div class="sidebar-first" data-options="region:'west',split:true" style="width:15%;">
            <?php print render($page['sidebar_first']); ?>
        </div> 
        <div id="inspect-mainContent"class="main content-wraper" data-options="region:'center',split:true" style="width:84%; padding-bottom: 5px;">
            <div class="easyui-layout" data-options="fit:true">
                <div class="common_left" data-options="region:'west',border:false" style="width:195px;">
                    <div class="common_left_inner easyui-layout" data-options="fit:true">
                        <ul class="submenu">
                            <li><a class="active" pid="1" href="javascript:void(0);" onClick="switchInspectPage(this)" ><span class="bg01">二维码管理</span></a></li>
                            <li><a pid="2" href="javascript:void(0);"  url="<?php print url('fireinspect/corpcheck'); ?>" onClick="switchInspectPage(this);"><span class="bg02">消防巡检</span></a></li>
                            <li><a pid="3" href="javascript:void(0);"  url="<?php print url('fireinspect/maintancecheck'); ?>" onClick="switchInspectPage(this);"><span class="bg03">维保单位巡检</span></a></li>
                            <li><a pid="4" href="javascript:void(0);"  url="<?php print url('fireinspect/maintenanceinfo'); ?>" onClick="switchInspectPage(this);"><span class="bg04">维保信息</span></a></li>
                            <li><a pid="5" href="javascript:void(0);"  url="<?php print url('fireinspect/urgeorder'); ?>" onClick="switchInspectPage(this);"><span class="bg05">督办单管理</span></a></li>
                        </ul>
                    </div>
                </div>
                <div id="mainContent" data-options="region:'center',border:false">
    ...
    <?php else: ?>
        <div id="inspect-mainContent" class="main content-wraper" data-options="region:'center',split:true" style="width:100%;height: 600px;">
           <div class="easyui-layout" data-options="fit:true">
                <div class="common_left" data-options="region:'west',border:false" style="width:195px;">
                    <div class="common_left_inner easyui-layout" data-options="fit:true">
                        <ul class="submenu">
                            <li><a class="active" pid="1" href="javascript:void(0);" url="<?php print url('fireinspect/qrcode'); ?>" onClick="switchInspectPage(this)" ><span class="bg01">二维码管理</span></a></li>
                            <li><a pid="2" href="javascript:void(0);"  url="<?php print url('fireinspect/corpcheck'); ?>" onClick="switchInspectPage(this);"><span class="bg02">消防巡检</span></a></li>
                            <li><a pid="3" href="javascript:void(0);"  url="<?php print url('fireinspect/maintancecheck'); ?>" onClick="switchInspectPage(this);"><span class="bg03">维保单位巡检</span></a></li>
                            <li><a pid="4" href="javascript:void(0);"  url="<?php print url('fireinspect/maintenanceinfo'); ?>" onClick="switchInspectPage(this);"><span class="bg04">维保信息</span></a></li>
                            <li><a pid="5" href="javascript:void(0);"  url="<?php print url('fireinspect/urgeorder'); ?>" onClick="switchInspectPage(this);"><span class="bg05">督办单管理</span></a></li>
...
<div class="footerwrap" data-options="region:'south',border:false">
    <p class="footer">2015-01-15  09:05:05</p>
</div>
...
<div class="usermore">
    <div class="usermorebox">
        ...
        <div class="item last"><a href="<?php print url('user/logout');?>">退出登录</a></div>
    </div>
</div>
<!--usermore end-->
<div class="skinmore">
