...
<div class="headerwrap" data-options="region:'north',border:false">
    ...
    <div class="header">
        ...
        <h1 class="logo"><a href="<?php print url('homepage'); ?>"><img src="<?php print $logo; ?>" alt="中巴一带一路" /></a></h1>
...
<div class="easyui-layout" data-options="fit:true">
   ...
   <?php if ($page['sidebar_first']): ?>
        ...
        <div id="mainContent" class="main content-wraper" data-options="region:'center',split:true" style="width:84%;">
    ...
    <?php else: ?>
        ...
        <div id="mainContent" class="main content-wraper" data-options="region:'center',split:true" style="width:100%;">
...
<div id="ResetUserInfo" class="easyui-dialog dialog_oneCol" title="修改个人信息" closed="true" data-options="buttons: '#RsetUserBtn', modal:true">    
    ...
    <form id="HeaderForm01" method="post">
        ...
        <table class="table01">
            ...
            <tr>
                ...
                <td colspan="3"><input class="easyui-textbox entry12" type="text" name="name" data-options="prompt:'xxxxx',disabled:true" /></td>
            ...
            <tr>
                ...
                <td colspan="3"><input class="easyui-textbox entry12" type="text" name="email" data-options="required:true" /></td>
            ...
            <tr>
                ...
                <td colspan="3"><select class="easyui-combobox entry12" name="language" data-options="disabled:true"><option value="ar">域管理员</option></select></td>
            ...
            <tr>
                ...
                <td colspan="3"><input class="easyui-textbox entry12" type="text" name="email" data-options="required:true,validType:'email'" /></td>
            ...
            <tr>
                ...
                <td colspan="3"><input class="easyui-textbox entry12" name="calling" /></td>
            ...
            <tr>
                ...
                <td colspan="3"><input class="easyui-textbox entry12" name="message" data-options="multiline:true" style="height:60px" /></td>
...
<div id="ResetPW" class="easyui-dialog dialog_oneCol" title="修改密码" closed="true" data-options="buttons: '#RsetPWBtn', modal:true">  
    ...
    <form id="HeaderForm02" method="post">
        ...
        <table class="table01">
            ...
            <tr>
                ...
                <td><input class="easyui-textbox entry12" type="password" data-options="required:true" /></td>
...
<div id="SubmitLog" class="easyui-dialog dialog_oneCol" title="提交反馈" closed="true" data-options="buttons: '#SubmitLogBtn', modal:true"> 
    ...
    <form id="HeaderForm03" method="post">
        ...
        <table class="table01" cellpadding="5">
            ...
            <tr>
                ...
                <p class="mb5"><input class="easyui-textbox entry12" type="text" data-options="required:true" /></p>
