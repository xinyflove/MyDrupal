...
<div class="box col3 masonry-brick">
   ...
   <div class="box-content">
       <p class="thum">    
             <a href="<?php print $node_url; ?>"><img src="http://owncloud.vpaas.net/sites/default/files/styles/pin/public/Screen%20Shot%202015-12-06%20at%208.50.18%20PM.png?itok=dwIFWpjl"></a>       </p>
       <p class="txt">    
            <?php print substr($node->body['und'][0]['value'],0,80).'... ...'; ?> </p>
   </div>    
</div>
