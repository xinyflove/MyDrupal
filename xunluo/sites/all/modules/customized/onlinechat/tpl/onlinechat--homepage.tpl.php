 ...
 <div id="data-chart-wordmap" style="height:600px;"></div>
...
var radius = [40, 55];
        ...
        require(
                [
                    'echarts',
                    'echarts/chart/map' // 使用地图图就加载bar模块，按需加载
                ],
                function(ec) {
                    // 基于准备好的dom，初始化echarts图表
                    myChart2 = ec.init(document.getElementById('data-chart-wordmap'));
                    var effect = {
                    show: true,
    ...
    series : [
        {
            ...
            geoCoord: {
                '兰州':[72.069083,54.01373],
                '北京':[116.4075,39.9040],
                'l2':[28.748048,12.824091],
            }
        }
    ]
};
