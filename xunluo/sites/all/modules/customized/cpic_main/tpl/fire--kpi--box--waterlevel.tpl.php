    ...
    <div class="maintop" data-options="region:'north',border:false">
        <div class="main_header">
            <form id="daQueryForm" method="post">
                ...
                <div class="formTable">
                    <div style="width:100%; text-align:right; height:50px; line-height:50px; font-size:13px; color:#292f34;">
...
<div class="main_data" data-options="region:'center',border:false">
    <div class="resultBox">
        ...
        <div class="result-main">
            <div id="data-chart-waterlevel" style="height:500px;"></div>
       ...
       var myChart2;
        ...
        require(
                ...
                function(ec) {
                    ...
                    myChart2 = ec.init(document.getElementById('data-chart-waterlevel'));
                    // 过渡---------------------
                    ...
                    option = {
    title : {
        text: '<?php print $node->title; ?>消防水箱系统水位异常',
        x:'center'
    },
    tooltip : {
        trigger: 'item',
...
function doDrawDataChart() {
            ...
            if (asset_nid == '') {
                $.messager.show({// show error message
                    ...
                    $.post('/kpi/dataanalyse/box/<?php print $node->nid; ?>', {start: start, end: end, id: <?php print $node->nid; ?>}, function(result) {
                        if (result.errorMsg) {
                            myChart2.hideLoading();
                        $.messager.show({// show error message
                            title: '友情提示',
                        ...
                        //*重新绘制图表
                         option1 = {
                            title : {
                               text: '<?php print $node->title; ?>消防水箱系统水位状态',
                                subtext: start+'-'+end,
                                x:'center'
                            },
                            tooltip : {
