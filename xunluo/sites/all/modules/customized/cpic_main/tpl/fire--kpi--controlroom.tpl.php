...
<script type="text/javascript">
                                ...
                                require(
                                        ...
                                        function(ec) {
                                            ...
                                            myChart1 = ec.init(document.getElementById('main-chart-bar'));
                                            // 过渡---------------------
                                            ...
                                            option1 = {
                                                title: {
                                                    text: '<?php print $node->title; ?>控制室值班脱岗统计',
                                                    x:'center',
                                                   subtext: ''
                                                },
                                                tooltip: {
                                ...
                                function doDrawDataChart() {
                                    ...
                                    if (asset_nid == '') {
                                        ...
                                        $.post('/kpi/dataanalyse/controlroom/<?php print $node->nid; ?>', {start: start, end: end, id: <?php print $node->nid; ?>}, function(result) {
                                            if (result.errorMsg) {
                                                myChart1.hideLoading();
                                                $.messager.show({// show error message
                                                    title: '友情提示',
