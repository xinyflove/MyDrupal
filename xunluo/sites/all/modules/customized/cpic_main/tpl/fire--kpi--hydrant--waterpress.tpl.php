...
var myChart1;
        ...
        require(
            ...
            'echarts',
                    ...
                    myChart1 = ec.init(document.getElementById('main-chart-pie'));
                    // 过渡---------------------
                    ...
                    option1 = {
                            title : {
                               text: '<?php print $node->title; ?>消火栓系统水压状态',
                               x:'center',
                            },
                            tooltip : {
                                trigger: 'item',
                            ...
                            series : [
                            {
                                ...
                                center: ['50%', '60%'],
                                data:[
                                {value:<?php print $xdata; ?>, name:'正常'},
                                {value:<?php print $ydata; ?>, name:'异常'},
...
function doDrawDataChart() {
            ...
            if (asset_nid == '') {
                $.messager.show({// show error message
                    ...
                    $.post('/kpi/dataanalyse/hydrant/<?php print $node->nid; ?>', {start: start, end: end, id: <?php print $node->nid; ?>}, function(result) {
                        if (result.errorMsg) {
                            myChart1.hideLoading();
                        $.messager.show({// show error message
                            title: '友情提示',
