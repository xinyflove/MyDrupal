    ...
    <div class="main_data" data-options="region:'center',border:false">
        <div class="resultBox">
            ...
            <div class="result-main">
                <div id="main-chart-bar" style="height:500px;"></div>
...
<script type="text/javascript">
                                ...
                                require(
                                        ...
                                        function(ec) {
                                            ...
                                            myChart2 = ec.init(document.getElementById('main-chart-bar'));
                                            // 过渡---------------------
                                            ...
                                            option1 = {
                                                title: {
                                                    text: '<?php print $node->title; ?>消防车道占用统计',
                                                    x:'center',
                                                    subtext: ''
                                ...
                                function doDrawDataChart() {
                                    ...
                                    if (asset_nid == '') {
                                        ...
                                        $.post('/kpi/dataanalyse/firelane/<?php print $node->nid; ?>', {start: start, end: end, id: <?php print $node->nid; ?>}, function(result) {
                                            if (result.errorMsg) {
                                                myChart2.hideLoading();
                                                $.messager.show({// show error message
                                                    title: '友情提示',
                                            ...
                                            option1 = {
                                                title: {
                                                    text: '<?php print $node->title; ?>消防车道占道统计',
                                                    x:'center',
                                                },
                                                tooltip: {
                                                    trigger: 'axis'
